        ...
        <div ref={gridRef} className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {PRODUCTS_DATA.map((product) => (
            ...
            >
              {/* Image */}
              <div
                className={`relative overflow-hidden bg-gradient-to-b ${product.accent} aspect-[4/5]`}
              >
                <Image
                  src={product.image}
                  alt={product.name}
                ...
                <div className="absolute left-3 top-3">
                  <span
                    className={`rounded-full px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider ${product.tagStyle}`}
                  >
                    {product.tag}
                  </span>
                </div>
              ...
              <div className="flex flex-1 flex-col p-5">
                <h3 className="font-display text-lg text-kraft-dark dark:text-kraft-dark">
                  {product.name}
                </h3>
                <p className="mt-1.5 text-xs leading-relaxed text-olive/75 dark:text-olive/70">
                  {product.texture}
                </p>
                ...
                <div className="mt-auto flex items-center justify-between border-t border-kraft/10 pt-4 dark:border-kraft/8">
                  <p className="font-display text-base font-medium text-kraft dark:text-kraft">
                    {product.price}
                  </p>
                  <button
