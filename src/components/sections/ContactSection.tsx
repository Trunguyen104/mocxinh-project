...
export function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -left-32 top-0 h-[500px] w-[500px] rounded-full bg-olive/5 blur-[120px] dark:bg-olive/3"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -right-20 bottom-0 h-[400px] w-[400px] rounded-full bg-kraft/4 blur-[100px] dark:bg-kraft/2"
        aria-hidden
      />
        ...
        <div className="grid gap-12 lg:grid-cols-5">
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label
                        ...
                        className="text-xs font-medium uppercase tracking-wider text-olive dark:text-olive"
                      >
                        {t("contact_form_name")}
                      </label>
                      <input
          ...
          <div ref={infoRef} className="flex flex-col gap-6 lg:col-span-2">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={item.label} className="flex gap-3">
                    ...
                    <div>
                      <p className="text-xs font-medium uppercase tracking-wider text-olive/60 dark:text-olive/50">
                        {item.label}
                      </p>
                      {item.href ? (
                        <a
                          href={item.href}
                          className="mt-0.5 text-sm text-kraft-dark transition-colors hover:text-olive dark:text-kraft-dark dark:hover:text-olive"
                        >
                          {item.value}
                        </a>
                      ) : (
                        <p className="mt-0.5 text-sm text-kraft-dark dark:text-kraft-dark">
                          {item.value}
                        </p>
                      )}
                    </div>
            ...
            <div className="rounded-3xl border border-olive/12 bg-gradient-to-br from-kraft-dark to-olive-dark p-8 text-center shadow-paper">
              ...
              <p className="mb-5 font-display text-lg text-ivory">
                Cập nhật sản phẩm mới & câu chuyện tự nhiên
              </p>
              <div className="flex justify-center gap-3">
                {["Facebook", "Instagram", "Zalo"].map((s) => (
                  <a
                    ...
                    href={
                      s === "Facebook"
                        ? "https://www.facebook.com/cogiaymocxinh"
                        : s === "Instagram"
                          ? "https://www.instagram.com/cogiaymocxinh"
                          : "https://zalo.me/0909090909"
                    }
