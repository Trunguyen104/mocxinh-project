...
export function CoreValuesSection() {
  ...
  const CORE_VALUES = [
    {
      ...
      icon: "🌿",
      stat: t("value1_stat"),
      statLabel: t("value1_stat_label"),
      color:
        "from-moc-green-pale/60 to-moc-green-pale/20 dark:from-moc-green-pale/40 dark:to-moc-green-pale/10",
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -right-32 top-1/4 h-[500px] w-[500px] rounded-full bg-moc-green/5 blur-[100px] dark:bg-moc-green/3"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -left-20 bottom-0 h-[400px] w-[400px] rounded-full bg-moc-green/4 blur-[80px] dark:bg-moc-green/2"
        aria-hidden
      />
      ...
      <div className="relative mx-auto max-w-6xl px-6 lg:px-10">
        ...
        <div ref={headRef} className="mb-16 text-center">
          ...
          <h2 className="font-display text-4xl text-kraft-dark dark:text-kraft-dark md:text-5xl">
            {t("values_title_1")}{" "}
            <span className="italic text-olive dark:text-olive">{t("values_title_italic")}</span>
          </h2>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {CORE_VALUES.map((value) => (
            ...
            >
              <div
                className={`mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl ${value.iconBg} transition-transform duration-500 group-hover:scale-110`}
              >
              ...
              <div className="mb-4">
                <p className={`font-display text-4xl font-light ${value.statColor}`}>
                  {value.stat}
                </p>
              ...
              <p className="mt-3 text-sm leading-relaxed text-olive-dark/75 dark:text-olive-dark/70">
                {value.description}
              </p>
              <div
                className="pointer-events-none absolute -bottom-6 -right-6 h-24 w-24 rounded-full bg-gradient-to-br from-moc-green/5 to-transparent"
                aria-hidden
              />
            </article>
          ))}
        ...
        <div className="testimonials-row mt-16 grid gap-6 md:grid-cols-2">
          {TESTIMONIALS.map((t_) => (
            ...
            >
              ...
              <p className="italic leading-relaxed text-kraft-dark/80 dark:text-kraft-dark/80">
                {t_.text}
              </p>
              <div className="mt-5 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-kraft-dark dark:text-kraft-dark">
                    {t_.author}
                  </p>
