          ...
          <div>
            ...
            <address className="space-y-3 not-italic text-sm text-ivory/65">
              <p className="flex items-start gap-2">
                <svg className="mt-0.5 h-4 w-4 flex-none text-olive/50" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <a href={`mailto:${CONTACT.email}`} className="flex items-center gap-2 transition-colors hover:text-ivory">
                <svg className="h-4 w-4 flex-none text-olive/50" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <rect x="1.5" y="3.5" width="13" height="9" rx="1.5" />
                  <path d="M1.5 5.5l6.5 4.5 6.5-4.5" />
                </svg>
                {CONTACT.email}
              </a>
              <a href={`tel:${CONTACT.phone}`} className="flex items-center gap-2 transition-colors hover:text-ivory">
                <svg className="h-4 w-4 flex-none text-olive/50" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
